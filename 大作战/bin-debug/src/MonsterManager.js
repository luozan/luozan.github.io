...
var MonsterManager = (function (_super) {
    ...
    var __egretProto__ = MonsterManager.prototype;
    //创建计时器
    ...
    __egretProto__.updatePeople = function () {
    ...
    __egretProto__.addFight = function (attackerType, place) {
        var fight = new this.place();
    ...
    __egretProto__.startCheckFight = function () {
        this.addEventListener(egret.Event.ENTER_FRAME, this.fight, this);
    };
    __egretProto__.stopCheckFight = function () {
    ...
    //排序函数
    __egretProto__.compare = function (a, b) {
        return a.value - b.value;
    };
    return MonsterManager;
})(egret.DisplayObjectContainer);
MonsterManager.prototype.__class__ = "MonsterManager";
