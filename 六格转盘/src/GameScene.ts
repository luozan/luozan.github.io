...
class GameScene extends egret.DisplayObjectContainer{
    ...
    private  arr:any;
    private userInfo;
    private IMAGE_WIDTH = 30;
    private IMAGE_HEIGHT = 48;
    private isHit = false;
    private token = null;
    private fil = /^1[3|4|5|8][0-9]\d{8}$/;
    public constructor(arr,userInfo){
        super();
        this.arr = arr;
    ...
    private createUI(){
        ...
        //底盘
        var roulSprite:any = new egret.Sprite();
        ...
        pointer.addEventListener(egret.TouchEvent.TOUCH_TAP,function(){
            ...
            //创建POST请求
            var url:string = "http://yz.doupu.cn/number2.php";
            ...
            loader.addEventListener(egret.Event.COMPLETE,function(event){
                ...
                var angle2 = 14400  - 30 + ((6-this.number)*60) + 10 + 40*Math.random();
