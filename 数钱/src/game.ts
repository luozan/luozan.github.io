...
class game extends egret.DisplayObjectContainer{
    ...
    private createMoney(){
        ...
        this.bg.addEventListener(egret.TouchEvent.TOUCH_BEGIN,function(event:any){
            if(this.isFirst){
                    this.timer();
                this.isFirst = false;
            }
        ...
        this.bg.addEventListener(egret.TouchEvent.TOUCH_MOVE,function(event:any){
        ...
        this.bg.addEventListener(egret.TouchEvent.TOUCH_END,function(event:any){
